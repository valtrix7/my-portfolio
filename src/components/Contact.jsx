          ...
          <div className="contact-left">
            ...
            <div className="contact-social-bento">
              ...
              <SocialBentoCard
                ...
                href="https://linkedin.com/in/imabdullah"
            ...
            <div className="contact-profile-card">
              <div className="cpc-top">
                <div className="cpc-avatar-wrapper">
                  <img src="https://github.com/abdullah-codes7.png" alt="Abdullah" className="cpc-avatar" />
                </div>
              ...
              <div className="cpc-info-list">
                ...
                <div className="cpc-info-item">
                  ...
                  <span>contact@imabdullah.xyz</span>
                </div>
              </div>

              <div className="cpc-actions">
                <a href="mailto:contact@imabdullah.xyz" className="cpc-btn cpc-btn-primary">
